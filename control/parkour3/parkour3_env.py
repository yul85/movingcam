...
class SkateDartEnv(gym.Env):
    def __init__(self, ):
        ...
        self.ref_motion.reset_root_trajectory_parkour3(self.ref_skel)
        ...
        self.box0_size = [2.0, self.height_hat_list[0], 0.2]
    ...
    def reward(self):
        ...
        if self.lf_contact_start_frame2 <= self.current_frame <= self.lf_contact_end_frame2:
            contact_body_height_diff.append(max(0., abs(self.skel.body('h_heel_left').to_world()[0] - self.box_pos[2][0]) - self.box2_size[0]/4.))
            contact_body_height_diff.append(self.skel.body('h_heel_left').to_world()[1] - self.height_hat_list[2] - 0.0249)
