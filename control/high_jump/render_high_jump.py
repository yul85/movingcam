...
import torch
from control.high_jump.high_jump_ppo_mp import PPO
...
def main():
    ...
    if not MOTION_ONLY:
        ppo.LoadModel('high_jump_model/max.pt')
        ppo.model.eval()
    ...
    # for bvh file
    bvh_qs = []
    bvh_file_name = 'high_jump_output.bvh'
    ...
    if not MOTION_ONLY:
        ...
        viewer.doc.addRenderer('openpose upvector',
                               yr.LinesRenderer(rd_openpose, (70, 70, 255)))
