...
import torch
from control.parkour1.parkour1_ppo_mp import PPO
...
def main():
    ...
    if not MOTION_ONLY:
        ppo.LoadModel('parkour1_model/max.pt')
        ppo.model.eval()
    ...
    # for bvh file
    bvh_qs = []
    bvh_file_name = 'parkour1_output.bvh'
    ...
    if MOTION_ONLY:
        ...
        viewer.setMaxFrame(ppo.env.motion_len-15)
