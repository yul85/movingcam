...
from optimize.parkour3.parkour3_param_box3.parkour3_param_box3_env import SkateDartEnv
from optimize.parkour3.parkour3_param_box2.parkour3_param_box2_ppo_mp import PPO as Win2PPO
...
class PPO(object):
    def __init__(self, env_name, num_slaves=1, eval_print=True, eval_log=True, visualize_only=False):
        ...
        self.make_init_distribution_ppo.LoadModel('../parkour3_param_box2/parkour3_param_box2_model/max.pt')
...
if __name__ == "__main__":
    ...
    tic = time.time()
    if len(sys.argv) < 2:
        ppo = PPO('parkour3_param_box3', 16)
    else:
