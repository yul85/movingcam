...
from optimize.parkour3.parkour3_param_box2.parkour3_param_box2_env import SkateDartEnv
from optimize.parkour3.parkour3_param_box1.parkour3_param_box1_ppo_mp import PPO as Win1PPO
...
class PPO(object):
    def __init__(self, env_name, num_slaves=1, eval_print=True, eval_log=True, visualize_only=False):
        ...
        self.make_init_distribution_ppo.LoadModel('../parkour3_param_box1/parkour3_param_box1_model/max.pt')
    ...
    def init_distribution_generate(self):
        ...
        while not is_done:
            ...
            total_reward += reward
            if self.make_init_distribution_ppo.env.current_frame == self.make_init_distribution_ppo.env.rf_contact_start_frame1:
                break
...
if __name__ == "__main__":
    ...
    tic = time.time()
    if len(sys.argv) < 2:
        ppo = PPO('parkour3_param_box2', 16)
    else:
